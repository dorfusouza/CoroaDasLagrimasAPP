...
em união às lágrimas derramadas por Maria Santíssima durante os momentos mais 
dolorosos de sua vida e especialmente na Paixão de Cristo. Cada grupo contém 
uma oração maior e sete menores, nas quais se suplica a Jesus pelas lágrimas 
da Sua Mãe Dolorosa.`,

  secao3_titulo: "Significado Espiritual das Lágrimas",
  secao3_texto: `As lágrimas de Maria são expressão de um amor materno perfeito, 
cheio de compaixão, entrega e intercessão. Elas representam a dor de uma Mãe 
que vê Seu Filho rejeitado e crucificado, mas também a esperança que se 
renova na Ressurreição. A tradição espiritual reconhece nelas um poderoso 
meio de intercessão em favor dos pecadores.`,

  secao4_titulo: "Continuidade da Devoção",
  secao4_texto: `Ao longo das décadas, a devoção foi sendo redescoberta e difundida 
em vários países. No Brasil, estudos recentes, meditações e edições devocionais 
auxiliaram a redescoberta dessa riqueza espiritual, convidando os fiéis a 
