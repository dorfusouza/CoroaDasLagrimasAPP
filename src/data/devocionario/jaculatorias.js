export const JACULATORIAS = [
  ...
  "Mãe das Dores, fortalecei-nos na cruz de cada dia!",
  "Lágrimas Santíssimas de Maria, iluminai nossa alma!",
  "Ó Mãe, que chorais por nós, conduzi-nos ao Coração de Jesus!"
];
